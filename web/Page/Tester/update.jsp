...
<body>
<div class="add">
    <form id="editform" action="<%=basePath%>Tester?method=editsubmit" method="post">
        <input type="hidden" name="stunumber" value="${student.stunumber}"></td>
        <table class="add_table" style="width: 75%;">
            ...
            <tr>
                <td>学生学号</td><td>${student.stunumber}</td>
            </tr>
            <tr>
                <td>班级</td>
                <td style="color: red"><input type="text" name="stuclass" value="${student.stuclass}"></td>
            </tr>
            <tr>
                <td>实验名称</td>
                <td style="color: red"><input type="text" name="testname" value="${student.testname}"></td>
            </tr>
            <tr>
