...
<table class="tablelist">
    ...
    <tr>
        ...
        <td>
            <button class="edit" type="button" onclick="window.location.href='<%=basePath%>Tester?method=edit&id=${student.stunumber}&testname=${student.testname}'">
                <i class="fa fa-edit"></i>
                修改
            </button>
            <button class="remove" type="button" keyword="${student.stunumber}">
