...
<%--        <td>实验人数</td>--%>
    ...
    <c:forEach items="${requestScope.pagebean.list}" var="experiment_score">
        <tr>
            ...
            <td>
                <button class="edit" type="button" onclick="window.location.href='<%=basePath%>Tester?method=edit1&id=${experiment_score.stu_id}'">
...
<table class="page">
    <td>
        <button onclick="window.location.href='<%=basePath%>Tester?method=fill&pageNo=1'">首页</button>
        <button onclick="window.location.href='<%=basePath%>Tester?method=fill&pageNo=${requestScope.pagebean.pageNo-1}'">上一页</button>
        <button onclick="window.location.href='<%=basePath%>Tester?method=fill&pageNo=${requestScope.pagebean.pageNo+1}'">下一页</button>
        <button onclick="window.location.href='<%=basePath%>Tester?method=fill&pageNo=${requestScope.pagebean.pageTotal}'">尾页</button>
