...
<div class="left">
  ...
  <div class="menux">
    ...
    <p>
      ...
      <ul>
        <li>
          <a href="javascript:void(0);" url="1.jsp" title="子功能1">
            <i class="fa fa-caret-right"></i>
            子功能1
          </a>
        </li>
        <li>
          <a href="javascript:void(0);" url="2.jsp" title="子功能2">
            <i class="fa fa-caret-right"></i>
            子功能2
          </a>
        </li>
        <li>
          <a href="javascript:void(0);" url="3.jsp" title="子功能3">
            <i class="fa fa-caret-right"></i>
            子功能3
          </a>
        </li>
    ...
    <ul>
      <li>
        <a href="javascript:void(0);" url="<%=basePath%>Tester?method=list" title="学生信息管理">
          <i class="fa fa-caret-right"></i>
          学生信息管理
        </a>
      </li>
      <li>
        <a href="javascript:void(0);" url="<%=basePath%>Tester?method=add" title="学生成绩录入">
          <i class="fa fa-caret-right"></i>
          学生成绩录入
        </a>
      </li>
      <li>
        <a href="javascript:void(0);" url="<%=basePath%>Tester?method=update" title="实验课程安排">
          <i class="fa fa-caret-right"></i>
          实验课程安排
        </a>
      </li>
