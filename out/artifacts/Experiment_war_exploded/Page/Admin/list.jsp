...
<div class="condition">
    ...
    <button onclick="window.location.href='Page/Admin/add.jsp'">
...
<table class="tablelist">
    ...
    <tr>
        ...
        <td>
            <button class="edit" type="button" onclick="window.location.href='<%=basePath%>Admin?method=edit&id=${students.stu_id}'">
...
<table class="page">
    <td>
        <button onclick="window.location.href='<%=basePath%>Admin?method=page&pageNo=1'">首页</button>
        <button onclick="window.location.href='<%=basePath%>Admin?method=page&pageNo=${requestScope.pagebean.pageNo-1}'">上一页</button>
        <button onclick="window.location.href='<%=basePath%>Admin?method=page&pageNo=${requestScope.pagebean.pageNo+1}'">下一页</button>
        <button onclick="window.location.href='<%=basePath%>Admin?method=page&pageNo=${requestScope.pagebean.pageTotal}'">尾页</button>
