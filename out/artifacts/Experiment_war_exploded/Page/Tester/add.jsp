...
<div class="add">
    ...
    <table class="add_table" style="width: 75%;">
        <tr>
            <td>学生学号</td>
            <td style="color: red"><input type="text" name="id"></td>
        </tr>
        <tr>
            <td>班级</td>
            <td style="color: red"><input type="text" name="stu_class"></td>
        </tr>
        <tr>
            <td>课程ID</td>
            <td style="color: red"><input type="text" name="course_id"></td>
        </tr>
        <tr>
            <td>实验ID</td>
            <td style="color: red"><input type="text" name="experiment_id"></td>
        </tr>
        <tr>
